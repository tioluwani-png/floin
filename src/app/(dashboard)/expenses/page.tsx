...
export default function ExpensesPage() {
  ...
  const currentExpense = useMemo(
    () => expenseMonths.find((e) => e.month_year === currentMonth) || null,
            ...
            {currentOthers.map((other) => (
              ...
              >
                ...
                <button
                  ...
                  className="rounded-lg p-2 text-muted opacity-0 group-hover:opacity-100 hover:bg-floin-red-light hover:text-floin-red transition-all"
                >
